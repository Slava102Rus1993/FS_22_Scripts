...
function XMLSchema:generateSchema()
	...
	for _, xmlBaseValueType in ipairs(XMLValueType.BASE_TYPES) do
		currentLine, currentIndent = addSimpleType(currentLine, currentIndent, xmlBaseValueType.name, xmlBaseValueType.description, true, nil, , xmlBaseValueType.content)
	end
