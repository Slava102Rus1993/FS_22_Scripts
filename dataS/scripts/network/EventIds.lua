...
EventIds.EVENT_SLEEP_REQUEST_DENIED = nextEventId()
EventIds.EVENT_SLEEP_REQUEST_TIMEOUT = nextEventId()
EventIds.EVENT_SLEEP_REQUEST_PENDING = nextEventId()
EventIds.EVENT_SLEEP_RESPONSE = nextEventId()
EventIds.EVENT_SLEEP_ALLOWED = nextEventId()
...
EventIds.EVENT_WOODHARVESTER_CUT_LENGTH = nextEventId()
EventIds.EVENT_WOODHARVESTER_CUT_TREE = nextEventId()
EventIds.EVENT_WOODHARVESTER_HEADER_TILT = nextEventId()
